...
def handle_message(event):
    ...
    with ApiClient(configuration) as api_client:
        ...
        # ---------------------------------------------------
        # CASE 1: สมัคร/ยกเลิก (เหมือนเดิม)
        # ---------------------------------------------------
        ...
        # ---------------------------------------------------
        # CASE 2: ขอเมนูเลือกสถานี (กดจาก Rich Menu)
        # ---------------------------------------------------
        ...
        # ---------------------------------------------------
        # CASE 3: ผู้ใช้กดเลือกสถานี (ข้อความขึ้นต้นด้วย "ดู ...") [เพิ่มใหม่]
        # ---------------------------------------------------
        ...
        # ---------------------------------------------------
        # CASE 4: คาดการณ์น้ำท่วม (กดจาก Rich Menu) [เพิ่มใหม่]
        # ---------------------------------------------------
        ...
        # ---------------------------------------------------
        # CASE 6: ขอข้อมูลติดต่อฉุกเฉิน [เพิ่มใหม่]
        # ---------------------------------------------------
